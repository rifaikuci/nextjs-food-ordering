...
const AddProduct = ({ setIsProductModal }) => {
    ...
    const handleCreate = async () => {
        //cloudinary kütüphanesine kaydetme işlemi ,food-ordering orada açılan dosya ismi
        //dsu7dalcz -> cloudname ismi
        ...
        try {
            const uploadRes = await axios.post(
                "https://api.cloudinary.com/v1_1/dsu7dalcz/image/upload",
                data
            );
